...
["8858757423007","XACT - TINMAN","นิทาน myth","ต้นไม้เค้กมหัศจรรย์","A2"],
["8858757423021","XACT - TINMAN","นิทาน animal","ปลาหมึกน้อยนักคำนวน","A3"],
["9786161843809","Javis (จาร์วิส)","Javis (จาร์วิส)","ความลับของอลัน","A4"],
["9786161845551","Javis (จาร์วิส)","นิทาน ghost","เด็กชายผมดอกไม้","A5"],
["9786160453528","Rikako Matsuo (ริกะโกะ มะสึโอะ)","นิทาน legend","ของขวัญจากล็อตต้า","A6"],
["9786167786490","XACT - TINMAN","นิทาน explanatory","นาฬิกาในป่าใหญ่","A7"],
["9786167786483","XACT - TINMAN","นิทาน jataka","สร้ายคอของหนามแหลม","A8"],
["9786167786698","พรรณรวี ชัยอิ่นคำ","นิทาน jest","สามสหายผจญภัย","A9"],
["9786167786650","พรรณรวี ชัยอิ่นคำ","นิทาน religious","สุขสันต์วันเกิด","A10"]]

for defaultBook in defaultBooks:
    Book(defaultBook[0],defaultBook[1],defaultBook[2],defaultBook[3],defaultBook[4])

def displayBook(book):
    print("\nBook id: ",book.id)
    print("Book title: ",book.title)
    print(', '.join([str(author_name.name)for author_name in book.authors]))
...
def addBook():
    ...
    Book(isbn,author,title,subject,dds_number)
    print("\nadd book success")
